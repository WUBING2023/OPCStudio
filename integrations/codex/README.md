# OPC Studio for Codex

Local marketplace: `opc-studio-codex`. This package exposes the same three standard Skills and the same 17 `opc-mcp` tools as the other host adapter.
